...
export default function App() {
  ...
  // ตัวแปรจำค่าสำหรับการแก้ไขและลบ เปลี่ยนมาจำชื่อรายการตรงๆ (String) เพื่อแก้บั๊ก
  ...
  // 🛠️ แก้ไขบั๊กการลบอุปกรณ์ในตาราง
  ...
  // 🛠️ แก้ไขบั๊กการบันทึกรายการตั้งค่า (แก้ไขให้แม่นยำขึ้นโดยอิงชื่อ)
  ...
  // 🛠️ แก้ไขบั๊กลบรายการตั้งค่า (ลบแม่นๆ โดยดูจากชื่อรายการ)
  const handleDeleteSetting = async () => {
    if (deleteSettingConfirm !== null) {
      try {
        const key = settingsTab;
        // กรองเอาชื่อที่ตรงกับ deleteSettingConfirm ออก
